...
@riverpod
Stream<supabase.AuthState> authSessionStream(Ref ref) => supabase.Supabase.instance.client.auth.onAuthStateChange;
  ...
  Future<void> updateProfile({
    ...
    try {
      ...
      if (avatarFile != null) {
        ...
        avatarUrl = supabase.Supabase.instance.client.storage.from('avatars').getPublicUrl(fileName);
      }
